...
Pod::Spec.new do |spec|
  ...
  spec.source       				= { :http => "https://github.com/odkmedia/private_cocoapods_specs/releases/download/v0.0.9/openwrap-handler-dfp-3.1.0.zip" }

  spec.platform = :ios, "11.0"

  spec.vendored_frameworks		= "OpenWrapHandlers/OpenWrapHandlerDFP.xcframework"
